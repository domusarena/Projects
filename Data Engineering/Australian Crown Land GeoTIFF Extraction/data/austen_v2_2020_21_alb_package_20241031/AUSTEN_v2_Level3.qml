  ...
  <pipe>
    ...
    <rasterrenderer alphaBand="-1" band="1" type="paletted" opacity="1" nodataColor="">
      ...
      <colorPalette>
        ...
        <paletteEntry alpha="255" label="Freeholding lease" value="2112" color="#6a4061"/>
        <paletteEntry alpha="255" label="Pastoral perpetual lease" value="2121" color="#b06a92"/>
        <paletteEntry alpha="255" label="Pastoral perpetual lease" value="2122" color="#b06a92"/>
        <paletteEntry alpha="255" label="Other perpetual lease" value="2131" color="#d3b8e2"/>
        <paletteEntry alpha="255" label="Other perpetual lease" value="2132" color="#d3b8e2"/>
        <paletteEntry alpha="255" label="Pastoral term lease" value="2141" color="#e0684b"/>
        <paletteEntry alpha="255" label="Pastoral term lease" value="2142" color="#e0684b"/>
        <paletteEntry alpha="255" label="Other term lease" value="2151" color="#ecc182"/>
        <paletteEntry alpha="255" label="Other term lease" value="2152" color="#ecc182"/>
        <paletteEntry alpha="255" label="Other lease" value="2161" color="#e2cdb8"/>
        <paletteEntry alpha="255" label="Other lease" value="2162" color="#e2cdb8"/>
        <paletteEntry alpha="255" label="Nature conservation reserve" value="2211" color="#284e36"/>
        <paletteEntry alpha="255" label="Nature conservation reserve" value="2212" color="#284e36"/>
        <paletteEntry alpha="255" label="Multiple-use public forest" value="2221" color="#a8b400"/>
        <paletteEntry alpha="255" label="Multiple-use public forest" value="2222" color="#a8b400"/>
        <paletteEntry alpha="255" label="Other reserve" value="2231" color="#d6e342"/>
        <paletteEntry alpha="255" label="Other reserve" value="2232" color="#d6e342"/>
